...
class Figure5_27 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.figure5_27)
        getInterface(this)
    }

    fun getInterface(context: Context){
        val mainLayout = findViewById<LinearLayout>(R.id.figure5_27_main_layout)
    ...
    fun getBaseAsset(context: Context): LinearLayout{
        ...
        val asset = layoutInflater.inflate(R.layout.figure5_27_asset, null)
        asset.layoutParams = params

        val img = asset.findViewById<ImageView>(R.id.figure5_27_img)
        Glide.with(this).load(imgSrc[index]).into(img)

        val text = asset.findViewById<TextView>(R.id.figure5_27_text1)
        text.text = randomText(10)
        text.setTextColor(Color.BLACK)

        val text2 = asset.findViewById<TextView>(R.id.figure5_27_text2)
