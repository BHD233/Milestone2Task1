...
class Figure7_36 : AppCompatActivity() {
    ...
    fun getInterface(){
        val mainLayout = findViewById<LinearLayout>(R.id.figure7_36_main_layout)
    ...
    fun getBaseAsset(): View {
        val asset = layoutInflater.inflate(R.layout.figure7_36_asset, null)

        val text1 = asset.findViewById<TextView>(R.id.figure7_36_name)
        text1.text = randomText(10)

        val text2 = asset.findViewById<TextView>(R.id.figure7_36_title)
        text2.text = randomText(30)

        val img = asset.findViewById<ImageView>(R.id.figure7_36_img)
